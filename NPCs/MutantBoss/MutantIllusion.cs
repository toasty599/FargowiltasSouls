        ...
        public override void AI()
        {
            ...
            if (--NPC.ai[3] == 0)
            {
                ...
                if (Main.netMode != NetmodeID.MultiplayerClient)
                    Projectile.NewProjectile(mutant.GetSpawnSource_ForProjectile(), NPC.Center, Vector2.UnitY * -5, ModContent.ProjectileType<MutantPillar>(), mutant.damage / 3, 0, Main.myPlayer, ai0, NPC.whoAmI);
            }
        }
