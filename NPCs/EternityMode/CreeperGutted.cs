...
namespace FargowiltasSouls.NPCs.EternityMode
{
    public class CreeperGutted : ModNPC
    {
        ...
        {
            Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<Projectiles.CreeperHitbox>(), NPC.damage, 6f, (int)NPC.ai[0]);
