                        ...
                        case NPCID.MoonLordFreeEye:
                            if (Main.npc[(int)npc.ai[3]].active && Main.npc[(int)npc.ai[3]].type == NPCID.MoonLordCore)
                            {
                                    ...
                                    && Main.projectile[Counter[1]].type == ModContent.ProjectileType<LunarRitual>() && Main.projectile[Counter[1]].ai[1] == npc.ai[3])
                                {
                                    ...
                                    if (npc.Distance(Main.projectile[Counter[1]].Center) > 650) //stay within ritual range
                                    {
                                        npc.Center = Vector2.Lerp(npc.Center, Main.projectile[Counter[1]].Center + npc.DirectionFrom(Main.projectile[Counter[1]].Center) * 650, 0.05f);
                                    }
                                }
                            }
                            break;
