...
namespace FargowiltasSouls.Items.Accessories.Forces
{
    public class NatureForce : BaseForce
    {
        ...
        {
            base.SetDefaults();
            Tooltip.SetDefault(Language.GetTextValue("Mods.FargowiltasSouls.ItemExtra.NatureForce", Enchants[0], Enchants[1], Enchants[2], Enchants[3], ModContent.ItemType<SnowEnchant>(), Enchants[4], ModContent.ItemType<JungleEnchant>(), Enchants[5]));
