...
namespace FargowiltasSouls.Projectiles.Masomode
{
    public class MoonLordSun : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            spriteBatch.Draw(texture2D13, projectile.Center - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), new Microsoft.Xna.Framework.Rectangle?(rectangle), Color.White * projectile.Opacity, projectile.rotation, origin2, projectile.scale, SpriteEffects.None, 0);
