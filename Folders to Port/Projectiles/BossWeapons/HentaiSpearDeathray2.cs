...
namespace FargowiltasSouls.Projectiles.BossWeapons
{
    public class HentaiSpearDeathray2 : Deathrays.BaseDeathray
    {
        ...
        public override void AI()
        {
            ...
            {
                if (!Main.dedServ)
                    SoundEngine.PlaySound(mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/Zombie_104").WithVolume(0.6f), projectile.Center);
                //SoundEngine.PlaySound(SoundID.Item12, projectile.Center);
                //SoundEngine.PlaySound(SoundID.NPCKilled, (int)projectile.Center.X, (int)projectile.Center.Y, 6, 1f, 0.0f);
            }
            float num801 = .5f;
