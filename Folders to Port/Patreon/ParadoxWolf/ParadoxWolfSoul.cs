...
There is a cooldown of 3 seconds between uses");
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if (direction != 0)
            {
                ...
                Projectile.NewProjectile(player.Center, new Vector2(player.velocity.X, 0), ModContent.ProjectileType<WolfDashProj>(), (int)(50 * player.GetDamage(DamageClass.Melee)), 0f, player.whoAmI);
