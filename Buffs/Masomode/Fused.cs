    ...
    public class Fused : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.buffTime[buffIndex] == 2)
            {
                ...
                Projectile.NewProjectile(player.GetSource_Buff(buffIndex), player.Center, Vector2.Zero, ModContent.ProjectileType<FargowiltasSouls.Content.Projectiles.Masomode.FusedExplosion>(), damage, 12f, Main.myPlayer);
            }
        }
