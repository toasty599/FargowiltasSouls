        ...
        public override void OnKill(NPC npc)
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                for (int i = 0; i < 20; i++)
                {
                    ...
                    Projectile.NewProjectile(npc.GetSpawnSource_ForProjectile(), npc.Center + 4 * speed, speed, ProjectileID.FrostShard, FargoSoulsUtil.ScaledProjectileDamage(npc.damage), 0f, Main.myPlayer);
                }
            }
        }
