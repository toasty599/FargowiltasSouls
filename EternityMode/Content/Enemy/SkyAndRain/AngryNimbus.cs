    ...
    public class AngryNimbus : EModeNPCBehaviour
    {
        ...
        public override void AI(NPC npc)
        {
            ...
            if (++Counter >= 360)
            {
                ...
                {
                    Projectile.NewProjectile(npc.GetSpawnSource_ForProjectile(), new Vector2(npc.Center.X + 100, npc.Center.Y), Vector2.Zero, ProjectileID.VortexVortexLightning, 0, 1, Main.myPlayer, 0, 1);
                    Projectile.NewProjectile(npc.GetSpawnSource_ForProjectile(), new Vector2(npc.Center.X - 100, npc.Center.Y), Vector2.Zero, ProjectileID.VortexVortexLightning, 0, 1, Main.myPlayer, 0, 1);
                }
            }
        }
