...
namespace FargowiltasSouls.Content.Projectiles.Masomode
{
    public class DarkStar : ModProjectile
    {
        ...
        {
            Texture2D glow = ModContent.Request<Texture2D>("FargowiltasSouls/Content/Projectiles/Masomode/DarkStar_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
