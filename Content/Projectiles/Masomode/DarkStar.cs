...
namespace FargowiltasSouls.Content.Projectiles.Masomode
{
    public class DarkStar : ModProjectile
    {
        ...
        {
            Texture2D glow = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Content/Projectiles/Masomode/DarkStar_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
