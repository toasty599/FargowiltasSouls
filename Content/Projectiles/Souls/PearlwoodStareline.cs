...
namespace FargowiltasSouls.Content.Projectiles.Souls
{
    internal class PearlwoodStareline : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (modPlayer.PearlwoodEnchantItem != null && modPlayer.ForceEffect(modPlayer.PearlwoodEnchantItem.type)) { Projectile.friendly = true; } //ability to hit enemy with froce
