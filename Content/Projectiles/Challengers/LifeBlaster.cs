...
namespace FargowiltasSouls.Content.Projectiles.Challengers
{
    ...
    public class LifeBlaster : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D glowTexture = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Content/Projectiles/Challengers/LifeBlasterGlow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
