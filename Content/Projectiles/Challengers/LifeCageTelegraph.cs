...
namespace FargowiltasSouls.Content.Projectiles.Challengers
{
    ...
    {
        public override string Texture => "FargowiltasSouls/Content/Projectiles/Challengers/LifeCageProjectile";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < 26; i++)
            {
                for (int j = 0; j < 2; j++)
                {
                    Vector2 pos1 = new Vector2(Projectile.Center.X - 300 + 600 * j, Projectile.Center.Y - 300 + 24 * i);
                    Vector2 pos2 = new Vector2(Projectile.Center.X - 300 + 24 * i, Projectile.Center.Y - 300 + 600 * j);
