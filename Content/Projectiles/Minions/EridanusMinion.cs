...
namespace FargowiltasSouls.Content.Projectiles.Minions
{
    public class EridanusMinion : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D glowTex = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Content/Bosses/Champions/Cosmos/CosmosChampion_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            Texture2D glowerTex = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Content/Bosses/Champions/Cosmos/CosmosChampion_Glow2", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
