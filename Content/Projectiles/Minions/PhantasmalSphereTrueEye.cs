...
namespace FargowiltasSouls.Content.Projectiles.Minions
{
    public class PhantasmalSphereTrueEye : ModProjectile
    {
        ...
        {
            Texture2D glow = ModContent.Request<Texture2D>("FargowiltasSouls/Content/Projectiles/MutantBoss/MutantSphereGlow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
