...
namespace FargowiltasSouls.Content.Projectiles.Minions
{
    public class DestroyerHead2 : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D glow = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Content/Projectiles/Minions/DestroyerHead2_glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
