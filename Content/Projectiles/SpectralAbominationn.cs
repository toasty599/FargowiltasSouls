...
namespace FargowiltasSouls.Content.Projectiles
{
    public class SpectralAbominationn : ModProjectile
    {
        ...
        {
            Texture2D texture2D13 = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Content/Projectiles/AbomScytheFriendly", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
