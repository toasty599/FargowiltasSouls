...
namespace FargowiltasSouls.Content.Projectiles.DeviBoss
{
    public class DeviBoss : ModProjectile
    {
        public override string Texture => "FargowiltasSouls/Content/NPCs/DeviBoss/DeviBoss";
        public static int npcType => ModContent.NPCType<NPCs.DeviBoss.DeviBoss>();
