...
namespace FargowiltasSouls.Content.Projectiles.Champions
{
    public class WillDeathraySmall : Deathrays.BaseDeathray
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Entity.InheritSource(Projectile), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<WillDeathrayBig>(), Projectile.damage, 0f, Main.myPlayer, 0f, Projectile.ai[1]);
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            LaserDrawer ??= new PrimDrawer(WidthFunction, ColorFunction, GameShaders.Misc["FargowiltasSouls:WillDeathray"]);
