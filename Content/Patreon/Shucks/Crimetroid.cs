...
namespace FargowiltasSouls.Patreon.Shucks
{
    public class Crimetroid : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D14 = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Content/Patreon/Shucks/CrimetroidJelly", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
