...
namespace FargowiltasSouls.Content.Bosses.BanishedBaron
{
    ...
    public class BaronRocket : ModProjectile
    {
        ...
        {
            Texture2D texture2D13 = Projectile.ai[0] != 3 ? Terraria.GameContent.TextureAssets.Projectile[Projectile.type].Value : FargowiltasSouls.Instance.Assets.Request<Texture2D>("Content/NPCs/Bosses/BanishedBaron/BaronRocketTorp", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
