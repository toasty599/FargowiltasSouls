...
namespace FargowiltasSouls.Content.Bosses.VanillaEternity
{
	public class Betsy : EModeNPCBehaviour
    {
        ...
        {
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy1"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy2"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy3"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy4"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy5"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy6"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy7"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy8"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy9"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy10"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy11"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy12"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy13"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy14"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy15"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy16"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy17"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy18"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy19"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy20"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy21"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy22"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy23"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy24"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy25"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy26"),
            Language.GetText("Mods.FargowiltasSouls.EternityMode.Betsy27"),
        };
    }
}
