	...
	public class Retinazer : EModeNPCBehaviour
    {
            ...
            if (WorldSavingSystem.MasochistModeReal && spazmatism == null && npc.HasValidTarget && ++RespawnTimer > 600)
            {
                ...
                if (FargoSoulsUtil.HostCheck)
                {
                    ...
                    if (n != Main.maxNPCs)
                    {
                        ...
                        FargoSoulsUtil.PrintText(Language.GetTextValue($"Mods.{Mod.Name}.Message.TwinsRevive", Main.npc[n].FullName), new Color(175, 75, 255));
                    }
                }
            }
        ...
        public override bool CheckDead(NPC npc)
        {
            ...
            if (FargoSoulsUtil.BossIsAlive(ref EModeGlobalNPC.spazBoss, NPCID.Spazmatism) && Main.npc[EModeGlobalNPC.spazBoss].life > 1) //spaz still active
            {
                ...
                {
                    HasSaidEndure = true;
                    FargoSoulsUtil.PrintText(Language.GetTextValue($"Mods.{Mod.Name}.Message.TwinsEndure", npc.FullName), new Color(175, 75, 255));
                }
                return false;
            }
