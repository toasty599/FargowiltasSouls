...
namespace FargowiltasSouls.Content.Bosses.MutantBoss
{
    public class MutantSlimeBall : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (sheetClamped > 3)
                sheetClamped = 3;
            Texture2D texture2D13 = FargowiltasSouls.Instance.Assets.Request<Texture2D>($"Content/Bosses/MutantBoss/MutantSlimeBall_{sheetClamped}", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
