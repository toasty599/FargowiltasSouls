...
namespace FargowiltasSouls.Content.Bosses.Champions.Shadow
{
    public class ShadowClone : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D14 = ModContent.Request<Texture2D>("FargowiltasSouls/Content/NPCs/Champions/ShadowChampion_Trail", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
