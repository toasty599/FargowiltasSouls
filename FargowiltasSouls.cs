    ...
    public partial class FargowiltasSouls : Mod
    {
        ...
        public override void PostSetupContent()
        {
            try
            {
                ...
                fargos.Call("AddSummon", 8.7f, "FargowiltasSouls", "BaronSummon", new Func<bool>(() => WorldSavingSystem.DownedBoss[(int)WorldSavingSystem.Downed.BanishedBaron]), Item.buyPrice(0, 22));
