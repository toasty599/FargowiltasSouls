    ...
    public class ShadowClone : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else if (Projectile.ai[1] == 0)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, Projectile.DirectionTo(player.Center), ModContent.ProjectileType<ShadowDeathraySmall>(), 0, 0f, Main.myPlayer);
                }
            }
