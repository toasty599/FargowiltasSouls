...
namespace FargowiltasSouls.Projectiles.JungleMimic
{
    public class AcornProjectile : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
        {
        	...
        	{
        		Projectile.NewProjectile(Entity.InheritSource(Projectile), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<AcornProjectileExplosion>(), Projectile.damage / 2, Projectile.knockBack, Projectile.owner, 0f, 0);
        	}
