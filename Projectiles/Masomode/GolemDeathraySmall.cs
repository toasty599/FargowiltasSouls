...
namespace FargowiltasSouls.Projectiles.Masomode
{
    public class GolemDeathraySmall : Deathrays.BaseDeathray
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, Projectile.velocity * 8, ProjectileID.GeyserTrap, Projectile.damage, 0f, Main.myPlayer);
            }
        }
    }
}