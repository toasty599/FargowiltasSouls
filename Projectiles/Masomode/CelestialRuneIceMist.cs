            ...
            if (Projectile.timeLeft % 60 == 0)
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    ...
                    if (Projectile.owner == Main.myPlayer)
                        Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, vel, ModContent.ProjectileType<CelestialRuneIceSpike>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.velocity.X, Projectile.velocity.Y);
                }
            }
