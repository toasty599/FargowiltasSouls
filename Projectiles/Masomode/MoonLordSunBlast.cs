        ...
        public override void AI()
        {
            ...
            if (++Projectile.localAI[1] == 6 && Projectile.ai[1] > 0 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                if (Projectile.localAI[0] != 2f)
                {
                    ...
                    int p = Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center + Main.rand.NextVector2Circular(20, 20), Vector2.Zero, Projectile.type,
                ...
                if (Projectile.localAI[0] != 1f)
                {
                    ...
                    int p = Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center + offset, Vector2.Zero, Projectile.type,
