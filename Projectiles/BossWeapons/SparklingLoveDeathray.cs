...
namespace FargowiltasSouls.Projectiles.BossWeapons
{
    public class SparklingLoveDeathray : Deathrays.BaseDeathray
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D20 = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Projectiles/Deathrays/DeviDeathray2", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            Texture2D texture2D21 = FargowiltasSouls.Instance.Assets.Request<Texture2D>("Projectiles/Deathrays/DeviDeathray3", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
