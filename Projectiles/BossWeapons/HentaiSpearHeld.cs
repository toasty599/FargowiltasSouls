    ...
    public class HentaiSpearHeld : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (--Projectile.localAI[0] < 0)
            {
                ...
                if (Projectile.owner == Main.myPlayer)
                    Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, Vector2.Zero, mod.ProjectileType("PhantasmalSphere"), Projectile.damage, Projectile.knockBack / 2, Projectile.owner);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < ProjectileID.Sets.TrailCacheLength[Projectile.type]; i += 2)
            {
                ...
                Main.EntitySpriteDraw(texture2D13, value4 + Projectile.Size / 2f - Main.screenPosition + new Vector2(0, Projectile.gfxOffY), new Microsoft.Xna.Framework.Rectangle?(rectangle), color27, num165, origin2, Projectile.scale, SpriteEffects.None, 0f);
            }*/
