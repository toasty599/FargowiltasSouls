...
namespace FargowiltasSouls.Projectiles.BossWeapons
{
    public class HentaiSpearArc : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            //Main.EntitySpriteDraw(texture2D13, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY), new Microsoft.Xna.Framework.Rectangle?(rectangle), Projectile.GetAlpha(lightColor), Projectile.rotation, origin2, Projectile.scale, SpriteEffects.None, 0f);
            return false;
        }
    }
}